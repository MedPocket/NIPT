---
title: "Tan máu bẩm sinh Thalassemia thể Alpha"
description: "Sàng lọc mất đoạn lớn và đột biến điểm trên gen HBA1, HBA2 gây phù thai tử vong trong tử cung hoặc thiếu máu tán huyết mạn tính."
---

- **Gen khảo sát:** _HBA1_ và _HBA2_ nằm trên nhiễm sắc thể thường số 16. Khảo sát 04 mất đoạn lớn phổ biến nhất gây bệnh: Mất đoạn Southeast Asian (--SEA), mất đoạn 3.7kb (-α3.7), mất đoạn 4.2kb (-α4.2), mất đoạn THAI; kết hợp 183 đột biến điểm gây bệnh bao gồm đột biến Hb Constant Spring (CS), Hb Quong Sze (QS).
